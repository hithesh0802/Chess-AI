...
max_fps = 15  
images = {}
colours = [p.Color('#EBEBD0'), p.Color("#54637C")] 
...
def load_images():
    ...
    for piece in pieces:
        images[piece] = p.transform.smoothscale(p.image.load(os.path.join(os.path.dirname(__file__), 'images', f'{piece}.png')),(sq_size, sq_size)
)
